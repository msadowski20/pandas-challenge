# pandas-challenge
This is the repository for Pandas homework assignment.

This repository contains the main Jupyter Notebook file with the code for the Heroes of Pymoli Pandas challenge.  It includes the purchase_data csv file used to run the anlysis.
